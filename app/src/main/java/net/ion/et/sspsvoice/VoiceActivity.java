...
public class VoiceActivity extends AppCompatActivity
{
    ...
    int mSubGameId = 0;
    final static int DEVICE_TYPE = 12;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Get subGameId from activity parameters
        Bundle bundle = getIntent().getExtras();
        mSubGameId = bundle.getInt("subGameId");
...
//            }, 1000);
        ...
        public void onResults(Bundle results) {
            ...
            try {
                ...
                message.put("subGameId", mSubGameId);
                message.put("deviceType", DEVICE_TYPE);
